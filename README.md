...
│   ├── verify.py                 # Скрипт проверки на 20 потоках
...
**Веб-дашборд** ([`dashboard/app.py`](dashboard/app.py)) — интерактивный дашборд на Streamlit с 4 вкладками:
1. **Аналитика** — KPI-метрики точности моделей, отображение графиков детекции, генерация графиков через verify.py.
2. **Детектирование** — классификация потока (ручной ввод 19 признаков, JSON-текст или загрузка JSON-файла), таблица результатов.
3. **Обучение** — переобучение моделей с выбором количества образцов.
4. **О проекте** — информация о технологиях и архитектуре.
...
Вкладки: Аналитика, Детектирование, Обучение, О проекте
...
**Тестовые потоки (20 шт: 14 норма + 6 атак):**

```
Тип трафика                   Статус     RF    MLP   IF   Ансамбль
-------------------------------------------------------------------
1. HTTP (веб-сёрфинг)         НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
2. HTTPS (защищённый сайт)    НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
3. SSH (удалённый доступ)     НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
4. DNS (запросы имён)         НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
5. FTP (скачивание файла)     НОРМА      НЕТ   НЕТ   ДА   НОРМА
6. SMTP (отправка почты)      НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
7. YouTube (стрим)            НОРМА      НЕТ   ДА    НЕТ  НОРМА *
8. Telegram (мессенджер)      НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
9. Online game (MMORPG)       НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
10. Music streaming            НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
11. BitTorrent (P2P)           НОРМА      НЕТ   НЕТ   ДА   НОРМА
12. Video call (Zoom)          НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
13. WebRTC (браузер)           НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
14. Cloud sync (Dropbox)       НОРМА      НЕТ   НЕТ   НЕТ  НОРМА
15. SYN-FLOOD                  АНОМАЛИЯ   ДА   ДА    ДА   АТАКА  <<<
16. PORT SCAN                  АНОМАЛИЯ   ДА   ДА    НЕТ  АТАКА  <<<
17. DDoS                       АНОМАЛИЯ   ДА   ДА    ДА   АТАКА  <<<
18. DNS Amplification          АНОМАЛИЯ   ДА   НЕТ   ДА   АТАКА  <<<
19. Slowloris                  АНОМАЛИЯ   ДА   ДА    ДА   АТАКА  <<<
20. ICMP Flood                 АНОМАЛИЯ   ДА   ДА    ДА   АТАКА  <<<
```

* YouTube стрим — ложное срабатывание MLP (FP), ансамбль исправляет.
